...
const EN: LocalizedCopy = {
  ...
  labels: {
    ...
    checkBack: "Check in tomorrow",
    checkBackSubtitle:
      "Your body clears debt overnight. One log each morning keeps your baseline honest.",
...
const ES: LocalizedCopy = {
  ...
  labels: {
    ...
    checkBack: "Registra mañana",
    checkBackSubtitle:
      "Tu cuerpo liquida deuda mientras duermes. Un log diario mantiene tu línea base real.",
...
const FR: LocalizedCopy = {
  ...
  labels: {
    ...
    checkBack: "Enregistre demain",
    checkBackSubtitle:
      "Ton corps efface la dette pendant la nuit. Un log quotidien garde ta baseline honnête.",
